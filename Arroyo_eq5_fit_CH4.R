...
# Import data
df_ch4 <- read_tsv("./data/ch4-bulk.tsv")
...
ggsave("./output/arroyo_eq5_CH4_boot1000_95CI.svg", eq5_plot, units = "cm", width = 12, height = 10)
...
#Save this plot direct from the output
