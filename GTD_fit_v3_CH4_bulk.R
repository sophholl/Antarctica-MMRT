...
# Import data
df_rates <- read_tsv("./data/ch4-bulk.tsv")
...
write_csv(boot_coefs_sum, "./output/boot_coefs_sum_CH4-all.csv")
...
ggsave("./output/GTD_CH4_boot1000_95CI.png", GTD_plot, units = "cm", width = 12, height = 10)
...
ggsave("./output/arroyo_eq5_CH4_residuals.svg", res_plot)
...
sink("./output/arroyo_eq5_CH4_fit_check.txt")
