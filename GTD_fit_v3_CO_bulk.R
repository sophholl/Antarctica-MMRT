...
# Import data
df_rates <- read_tsv("./data/co-bulk.tsv")
...
write_csv(boot_coefs_sum, "./output/boot_coefs_sum_CO-all.csv")
...
ggsave("./output/GTD_CO_boot1000_95CI.png", GTD_plot, units = "cm", width = 12, height = 10)
...
ggsave("./output/arroyo_eq5_CO_residuals.svg", res_plot)
...
sink("./output/arroyo_eq5_CO_fit_check.txt")
