...
# Import data
df_rates <- read_tsv("./data/co-cells.tsv")
...
write_csv(boot_coefs_sum, "./output/boot_coefs_sum_CO-cells.csv")
...
ggsave("./output/GTD_CO_cells_boot1000_95CI.png", GTD_plot, units = "cm", width = 12, height = 10)
...
ggsave("./output/GTD_CO_cells_residuals.png", res_plot)
...
sink("./output/GTD_CO_cells_fit_check.txt")
