...
# Import data
df_rates <- read_tsv("./data/ch4-cells.tsv")
...
write_csv(boot_coefs_sum, "./output/boot_coefs_sum_CH4-cells.csv")
...
ggsave("./output/GTD_CH4_cells_boot1000_95CI.png", GTD_plot, units = "cm", width = 12, height = 10)
...
ggsave("./output/GTD_CH4_cells_residuals.svg", res_plot)
...
sink("./output/GTD_CH4_cells_fit_check.txt")
