...
# Import data
df_rates <- read_tsv("./data/h2-cells.tsv")
...
write_csv(boot_coefs_sum, "./output/boot_coefs_sum_H2-cells.csv")

#Plot
GTD_plot_cells <- ggplot() +
...
ggsave("./output/GTD_H2_cells_boot1000_95CI.png", GTD_plot_cells, units = "cm", width = 12, height = 10)
...
ggsave("./output/GTD_H2_cells_residuals.png", res_plot)
...
sink("./output/GTD_H2_cells_fit_check.txt")
